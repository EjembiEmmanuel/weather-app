...
;// CONCATENATED MODULE: ./src/js/apiFncs.js
// Build weather url
...
;// CONCATENATED MODULE: ./src/js/domFncs.js
...
var src_location = document.querySelector("#location");
...
farenheit.addEventListener("click", async function () {
  var city = src_location.textContent;
  unit = "F";
  displayWeatherInfo(city, unit, false);
});
...
function renderData(data, unit) {
  ...
  src_location.textContent = data.location.name;
